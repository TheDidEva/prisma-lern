...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_fafvoriteById_fkey" FOREIGN KEY ("fafvoriteById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
